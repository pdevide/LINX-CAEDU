...
*!*							o_toolbar.botao_filhas_deletar.Enabled= .T.
			...
			case UPPER(xmetodo) == 'USR_INIT'
				...
				RELEASE ZZ_COMBO_LICENCIADOR, ZZ_COMBO_PERSONAGEM, ZZ_COMBO_MODELAGEM
				PRIVATE ZZ_COMBO_LICENCIADOR, ZZ_COMBO_PERSONAGEM, ZZ_COMBO_MODELAGEM
				STORE "" TO ZZ_COMBO_LICENCIADOR, ZZ_COMBO_PERSONAGEM, ZZ_COMBO_MODELAGEM
				
				lcSQL = "select PARAMETRO, NOTA_PROGRAMADOR from parametros "
				lcSQL = lcSQL + "where parametro in ('ROWSOURCE_LICENCIADOR','ROWSOURCE_PERSONAGEM','ROWSOURCE_MODELAGEM')"
