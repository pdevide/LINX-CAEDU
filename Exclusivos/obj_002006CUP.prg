...
*!*					ENDWITH				
				...
				thisformset.lx_FORM1.lx_pageframe1.pgImportado.addobject('cbo_supplier1', 'cbo_supplier')
				WITH thisformset.lx_FORM1.lx_pageframe1.pgImportado.cbo_supplier1
					.top = 260 -30
					.left = 90
				...
				thisformset.lx_FORM1.addobject('txt_stylenumber1', 'txt_stylenumber')
	...
	***
	...
	ELSE
		...
		*** SE ESTIVER COM O CAMPO ERP_CUPS_SEGMENTO VAZIO - GERA CODIGO DE BARRAS
		IF INLIST(v_produtos_00.ERP_CUPS_SEGMENTO,'000156','000157')
